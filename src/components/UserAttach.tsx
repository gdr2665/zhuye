  ...
  return (
    <div className='user_attach_container'>
      <div className='row'>
        ...
        <div className='drop'>
          <div
            className='drop_control'
            onClick={(e) => {
              dropClick(e, 0)
            }}
          >
            <div className={dropState[0] ? 'tran_active' : 'tran'}></div>
      ...
      <div className='row'>
        ...
        <div className='drop'>
          ...
          >
            <div className={dropState[1] ? 'tran_active' : 'tran'}></div>
          ...
          >
            <div className='menu_row'>回答1</div>
            <div className='menu_row'>回答2</div>
          </div>
        </div>
      </div>
